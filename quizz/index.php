            ...
            <div class="box w50">
                ...
                <div class="body_box">
                    <form action="index.php" id="form_login" method="post">
                        ...
                        <div class="div_input"><Button class="ipbtn" type="submit" name="connexion" >Connexion</button>&nbsp;&nbsp;&nbsp;<a href="index98b3.html?origin=inscription"><small>s'inscrire pour jouer</small></a></div>
                    </form>
                </div>
            </div>
            <script>
...
<!-- Mirrored from smb.alwaysdata.net/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 19 May 2020 04:40:49 GMT -->
</html>